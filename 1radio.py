...
from radio_util import RADIO , checkAndMakeDir

me = singleton.SingleInstance()
IPHONE_USER_AGENT = 'AppleCoreMedia/1.0.0.12B435 (iPhone; U; CPU OS 8_1_1 like Mac OS X; ko_kr)'
radio = RADIO('/radio/1radio')
req = urllib2.Request('http://kongapi.kbs.co.kr/api/kp_cms/live_stream','beta=0&is_bora=N&device_type=iphone&welcome=1_1985_1_1_0_1&channel_code=21')
